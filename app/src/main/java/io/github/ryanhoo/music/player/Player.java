...
public class Player implements IPlayback, MediaPlayer.OnCompletionListener {
    ...
    public boolean play(PlayList list) {
        ...
        Log.e("wzj", "[play] play index: " + list.getPlayingIndex());
        isPaused = false;
        setPlayList(list);
        return play();
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        Log.e("wzj", "[OnCompletion] play mode" + mPlayList.getPlayMode());
    ...
    private void notifyComplete(Song song) {
        Log.e("wzj", "callback conunt: " + mCallbacks.size());
        for (Callback callback : mCallbacks) {
