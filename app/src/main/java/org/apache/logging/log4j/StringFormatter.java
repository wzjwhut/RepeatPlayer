...
/**
 * 字符串格式化, 是从log4j中抠出来的, 使用log4j的{}作为占位符
 * 简单了测试了一下速度, 10万次操作
 * 本接口: 36 ms
 * String.format: 285 ms
 * StringBuilder: 11 ms
 * @author zijiang.wu
 *
 */
public class StringFormatter {
     ...
     */
    static public String format(final String messagePattern, final Object... arguments) {
     ...
     * @param arguments      the arguments to be used to replace placeholders.
     */
    static public void formatMessage(final StringBuilder buffer, final String messagePattern,
